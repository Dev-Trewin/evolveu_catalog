...
const CheckboxSection = (props) => {
   ...
   return (
      ...
      <div className="flex flex-row flex-wrap justify-around align-center">
         ...
         {/* Languages */}
         <form id="section-checkbox" className="">
            {/* <div className="flex flex-col md:flex-row flex-wrap"> */}

            <div id="section-languages" className="" >

                  <div className="pl-6 pb-2">Languages</div><br />
                  
                  <input
                     id="checkbox-html" type="checkbox" value="html"
                     className="mx-2"
                  ...
                  <input
                     id="checkbox-js" type="checkbox" value="js"
                     className="mx-2"
                     onChange={props.handleChangeCheckbox}
                  />
         ...
         <form id="section-checkbox" className="">
            <div className="flex flex-col md:flex-row flex-wrap">
               ...
               <div id="section-framework" className="" >
         ...
         <form id="section-checkbox" className="">
            <div id="section-backend" className="">
